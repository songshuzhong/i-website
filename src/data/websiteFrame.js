export default {
  ...
  menu: {
    ...
    title: '',
    initApi: {
      url: `${process.env.PUBLIC_PATH || ''}/api/0767bea4-c7e7-4aa7-a1b5-2fd5e1ec4a7f${process.env.VUE_APP_API_NODE_ENV === 'gp'? '.json': ''}`
    },
    body: []
  },
  header: {
    ...
    body: [
      {
        ...
        silentLoading: true,
        initApi: {
          url: `${process.env.PUBLIC_PATH || ''}/api/user${process.env.VUE_APP_API_NODE_ENV === 'gp'? '.json': ''}`,
          cached: true
        },
        body: [
          {
